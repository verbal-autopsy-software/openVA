...
[**vacalibration**](https://CRAN.R-project.org/package=vacalibration)
and an instructive introduction can be found in the package's
[vignette](https://CRAN.R-project.org/package=vacalibration/vignettes/intro_to_vacalibration.html).
...
[vacalibration vignette](https://CRAN.R-project.org/package=vacalibration/vignettes/intro_to_vacalibration.html#broad-cause-of-death)
).
